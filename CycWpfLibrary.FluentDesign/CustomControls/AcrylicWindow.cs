using CycWpfLibrary.FluentDesign.Utility;
using System;
...
namespace CycWpfLibrary.FluentDesign
{
    ...
    /// 追加します:
    ///
    ///     xmlns:MyNamespace="clr-namespace:CycWpfLibrary.FluentDesign"
    ///
    ///
    ...
    /// 追加します:
    ///
    ///     xmlns:MyNamespace="clr-namespace:CycWpfLibrary.FluentDesign;assembly=CycWpfLibrary.FluentDesign"
    ///
    ...
    public class AcrylicWindow : Window
    {
        ...
        private static void OnEnableChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (value)
            {
                var dic = new ResourceDictionary() { Source = new Uri("pack://application:,,,/CycWpfLibrary.FluentDesign;component/Styles/Window.xaml") };
